...
*/
  ...
  \**********************/
    ...
    var containerDiv = document.getElementById('app-content');
    // Add contents
    var content = document.createElement('div');
    content.className = 'flex-item';
    containerDiv.appendChild(content);
    (0, _samskara_ui_from_resize__WEBPACK_IMPORTED_MODULE_0__.fromResize)(content).subscribe(function (dimension) {
      return console.log('From Resize -> Dimension Updated. New Client Rect: ' + JSON.stringify(dimension));
    });
    setInterval(function () {
      var newWidth = Math.floor(Math.max(10, Math.random() * 100)) + '%';
